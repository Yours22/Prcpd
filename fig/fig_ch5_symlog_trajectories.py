# 图 5-5b: SymLog 消融 POD 系数轨迹对比 — 同一外推算例，仅展示快群 4 阶
import matplotlib
matplotlib.use('Agg')
...
ABL  = '2D-PINN/ablation/no_symlog/results'
